...
import { FizzRule, BuzzRule, FizzBuzzRule } from './rules';
...
describe(NumberListReplacer.name, () => {
  describe('when asked to get replacement to a number', () => {
    describe('and number is multiple of 3', () => {
      const numbers = [6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36, 39, 42, 45, 48, 51, 54, 57, 60];
    ...
    describe('and number is multiple of 5', () => {
      const numbers = [5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75];
