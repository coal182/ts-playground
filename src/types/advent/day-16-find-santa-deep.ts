type FindSanta<FOREST extends ('🎅🏼' | '🎄')[][]> = FOREST extends [
  ...infer Rest extends ('🎅🏼' | '🎄')[][],
  infer Last extends ('🎅🏼' | '🎄')[]
]
  ? FindSantaDeep<Last> extends number
    ? [Shift<FOREST>['length'], FindSantaDeep<Last>]
    : FindSanta<Rest>
  : never;

type FindSantaDeep<FOREST extends ('🎅🏼' | '🎄')[]> = FOREST extends [...infer Rest extends ('🎅🏼' | '🎄')[], infer Last]
  ? Last extends '🎅🏼'
    ? Rest['length']
    : FindSantaDeep<Rest>
  : false;
